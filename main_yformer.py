...
parser.add_argument('--data', type=str, required=True, default='dataset4', help='data')
parser.add_argument('--root_path', type=str, default='./data/dataset/', help='root path of the data file')
